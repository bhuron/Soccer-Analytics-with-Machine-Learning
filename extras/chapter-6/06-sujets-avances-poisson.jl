...
let
	...
	bar(collect(0:max_g) .- 0.2, obs_counts, bar_width=0.4, label="Observé",
		color=:steelblue, alpha=0.7, title="Distribution observée vs attendue (Poisson)",
		xlabel="Nombre de buts", ylabel="Fréquence")
	bar!(collect(0:max_g) .+ 0.2, exp_counts, bar_width=0.4, label="Attendu (Poisson)",
...
manifest_format = "2.0"
project_hash = "738c3ebc3c72fcca3003bd25fffd5e7b5fb9e288"
