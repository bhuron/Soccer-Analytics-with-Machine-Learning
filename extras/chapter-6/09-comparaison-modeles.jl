...
let
	...
	DataFrame(
		...
		AIC      = round.([StatsBase.aic(basic), StatsBase.aic(extended), StatsBase.aic(full)]; digits=1),
		BIC      = round.([StatsBase.bic(basic), StatsBase.bic(extended), StatsBase.bic(full)]; digits=1),
	)
end
